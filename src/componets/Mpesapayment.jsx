...
const submit= async(e)=>{
    ...
    <div className='row justify-content-center mt-4' >
        ...
        <h4 className='text-danger'>{product.product_name}</h4>
        <h4>Price: <span className='text.primary'>KES{product.product_cost}</span></h4>
        </div>
        <div className="col-md-6">
            ...
            <form onSubmit={submit} >
                ...
                <input type="number" className='form-control' value={product.product_cost} readOnly /> <br />
